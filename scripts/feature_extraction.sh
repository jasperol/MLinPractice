...
echo "  training set"
python -m scripts.feature_extraction.extract_features data/preprocessing/split/training.csv data/feature_extraction/training.pickle -e data/feature_extraction/pipeline.pickle --tweet_frequency --sentiment --hashtags_most_common --char_length --weekday --hashtags_num --words_most_common --replies_num --mentions_num 
