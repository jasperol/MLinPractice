...
echo "  training set"
python -m scripts.feature_extraction.extract_features data/preprocessing/split/training.csv data/feature_extraction/training.pickle -e data/feature_extraction/pipeline.pickle --tweet_frequency --sentiment --names_places --char_length --weekday --hashtags_most_common --hashtags_num --words_most_common
